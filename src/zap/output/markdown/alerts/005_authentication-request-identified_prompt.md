...
|---|---|---|---|---|---|
| 17 | POST | `http://localhost:3000/api/login` | `email` | `password` | `backend_basic.json` |
| 71 | POST | `http://localhost:3000/api/login` | `email` | `password` | `frontend_user_basic.json` |
| 149 | POST | `http://localhost:3000/api/login` | `email` | `password` | `frontend_admin_basic.json` |

Bằng chứng request/response runtime đại diện:
### Endpoint 17: POST http://localhost:3000/api/login
...
### Endpoint 71: POST http://localhost:3000/api/login
...
### Endpoint 149: POST http://localhost:3000/api/login
