...
| STT | Tên Alert | Độ nghiêm trọng | Tag lỗi / CWE | Số endpoint |
| --- | ----------------------------------------------------- | -------------------------------------------------------- | ------------ | ------------------- |
| 1 | Cross-Domain Misconfiguration | Medium | CWE-264 / WASC-14 | 12 |
| 2 | Server Leaks Information via "X-Powered-By" | Low | CWE-497 / WASC-13 | 15 |
| 3 | Missing Anti-clickjacking Header | Medium | CWE-1021 / WASC-15 | 14 |
| 4 | Path Traversal | High | CWE-22 / WASC-33 | 3 |
| 5 | Timestamp Disclosure - Unix | Low | CWE-497 / WASC-13 | 3 |
