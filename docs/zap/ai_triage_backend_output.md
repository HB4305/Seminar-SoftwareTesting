...
| Low | N/A | Server Leaks Information via "X-Powered-By" HTTP Response Header Field(s) | `GET http://localhost:3000/sitemap.xml` |

## AI Triage Note
Nguồn dữ liệu: `zap_report.html`. Bản này dùng offline template vì chưa gọi AI hoặc AI không khả dụng.
